...
import android.volley.toolbox.ImageRequest2;
...
public class ImageLoader {
	...
	public ImageLoader(RequestQueue queue, ImageCache imageCache, int defaultMaxWidth, int defaultMaxHeight) {
		mRequestQueue = queue;
		mCache = imageCache;
		mMaxWidth = defaultMaxWidth;
	...
	public ImageContainer get(String requestUrl, final ImageListener listener) {
		return get(requestUrl, listener, mMaxWidth, mMaxHeight);
	}
	...
	public ImageContainer get(String requestUrl, ImageListener imageListener, int maxWidth, int maxHeight) {
		...
		final String cacheKey = getCacheKey(requestUrl, mMaxWidth, mMaxHeight);
		...
		// network and
		// track it.
		Request<?> newRequest = new ImageRequest2(requestUrl, mMaxWidth, mMaxHeight, Config.RGB_565) {
			@Override
	...
	public class ImageContainer {
		...
		public void cancelRequest() {
			...
			mRequestQueue.cancelAll(mCacheKey);
