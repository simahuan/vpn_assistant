...
public class BlurDialogEngine {
     ...
     */
    private static final float BLUR_DOWN_SCALE_FACTOR = 2.0f;
     ...
     *
     * @param radius custom radius used to blur. 0<radius<=25
     */
    ...
    private void blur(Bitmap bkg, View view) {
        ...
        View content = mHoldingActivity.getWindow().findViewById(Window.ID_ANDROID_CONTENT);
        int contentTop = content.getTop();
		...
		overlay = FastBlurHelper.doBlur(mHoldingActivity,overlay, mBlurRadius, false);
		
		// set bitmap in an image view for final rendering
		mBlurredBackgroundView = new ImageView(mHoldingActivity);
		// mBlurredBackgroundView.setScaleType(ScaleType.FIT_XY);
